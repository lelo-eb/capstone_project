...
class Recipe {
   ...
   **/
  static async create({ title, description, ingredients, instructions, createdBy }) {
    const result = await db.query(
      `INSERT INTO recipes
       (title, description, ingredients, instructions, created_by)
       VALUES ($1, $2, $3, $4, $5)
      ...
      [title, description, ingredients, instructions, createdBy],
    );
